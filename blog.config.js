...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Scu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bk.9277.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Scu, 博客', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '👏欢迎来带我的博客👏', // 站点描述，被notion中的页面描述覆盖
